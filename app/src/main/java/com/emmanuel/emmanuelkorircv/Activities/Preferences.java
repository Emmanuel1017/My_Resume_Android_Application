...
import static com.emmanuel.emmanuelkorircv.HelperClasses.DeviceInfo.calcCpuCoreCount;
import static com.emmanuel.emmanuelkorircv.HelperClasses.DeviceInfo.externalMemoryAvailable;
import static com.emmanuel.emmanuelkorircv.HelperClasses.DeviceInfo.formatSize;
import static com.emmanuel.emmanuelkorircv.HelperClasses.DeviceInfo.formatSizeRAM;
import static com.emmanuel.emmanuelkorircv.HelperClasses.DeviceInfo.getAvailableExternalMemorySize;
import static com.emmanuel.emmanuelkorircv.HelperClasses.DeviceInfo.getAvailableInternalMemorySize;
import static com.emmanuel.emmanuelkorircv.HelperClasses.DeviceInfo.getTotalExternalMemorySize;
import static com.emmanuel.emmanuelkorircv.HelperClasses.DeviceInfo.getTotalInternalMemorySize;
import static com.emmanuel.emmanuelkorircv.HelperClasses.DeviceInfo.takeCurrentCpuFreq;
import static com.emmanuel.emmanuelkorircv.HelperClasses.DeviceInfo.takeMaxCpuFreq;
import static com.emmanuel.emmanuelkorircv.HelperClasses.DeviceInfo.thermalTemp;
...
import com.emmanuel.emmanuelkorircv.HelperClasses.DownloadTask;
import com.emmanuel.emmanuelkorircv.ProgressView;
...
// Start the initial runnable task by posting through the handler
        ...
        dir_ = new File(getApplicationContext().getFilesDir(), AppConstants.downloadDirectory);
            ...
            public void onClick(View view) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        sDialog.dismiss();
                        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(AppConstants.downloadPdfUrl));
                        startActivity(browserIntent);
...
// Start the initial runnable task by posting through the handler
    ...
    public boolean fileisFilePresent() {
        String path = dir_.getPath()+File.separator+ AppConstants.downloadFileName;
    ...
    public void checkPermission(String permission, int requestCode)
    {
        if (ContextCompat.checkSelfPermission(Preferences.this, permission) == PackageManager.PERMISSION_DENIED) {
            ...
            new DownloadTask(Preferences.this, AppConstants.downloadPdfUrl);
    ...
    private void shareApplication() {
        ...
        try {
            ...
            File tempFile = new File(getExternalCacheDir() +  "/"
                    + AppConstants.downloadDirectory+"/"+ AppConstants.downloadDirectoryapk);
