...
import com.emmanuel.emmanuelkorircv.listeners.AnimatorEndListener;
import com.emmanuel.emmanuelkorircv.listeners.OnSwipeListener;
import com.emmanuel.emmanuelkorircv.listeners.PaperOnboardingOnChangeListener;
import com.emmanuel.emmanuelkorircv.listeners.PaperOnboardingOnLeftOutListener;
import com.emmanuel.emmanuelkorircv.listeners.PaperOnboardingOnRightOutListener;
import com.emmanuel.emmanuelkorircv.utils.PaperOnboardingEngineDefaults;
...
public class PaperOnboardingEngine implements PaperOnboardingEngineDefaults {
    ...
    private final LinearLayout mContentRootLayout;
    ...
    public PaperOnboardingEngine(View rootLayout, ArrayList<PaperOnboardingPage> contentElements, Context appContext) {
        ...
        mContentRootLayout = (LinearLayout) mRootLayout.getChildAt(1);
    ...
    protected ViewGroup createPagerIconElement(int iconDrawableRes, boolean isActive) {
        ...
        FrameLayout bottomBarElement = (FrameLayout) vi.inflate(R.layout.onboarding_pager, mPagerIconsContainer, false);
    ...
    protected ViewGroup createContentTextView(PaperOnboardingPage PaperOnboardingPage) {
        LayoutInflater vi = LayoutInflater.from(mAppContext);
        ViewGroup contentTextView = (ViewGroup) vi.inflate(R.layout.onboarding_text, mContentTextContainer, false);
